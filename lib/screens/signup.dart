...
final TextEditingController userBirthday = TextEditingController();
final TextEditingController userPostalCode = TextEditingController();
...
class _SignUpState extends State<SignUp> {
  ...
  void vaildation() async {
    if (userName.text.isEmpty &&
      ...
      _scaffoldKey.currentState.showSnackBar(
        SnackBar(
          content: Text("Phone Number Must be of 10 letters "),
        ),
      );
