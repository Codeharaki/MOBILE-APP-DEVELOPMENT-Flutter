      ...
      (element) {
        if (currentUser.uid == element.data()["UserId"]) {
          userModel = UserModel(
              ...
              userBirthday: element.data()["userBirthday"],
              userPostalCode: element.data()["userPostalCode"],
              userCity: element.data()["userCity"]);
